...
public class DataProviderXml implements DataProvider {
    ...
    private <T extends Security> Result<T> appendSecurities(List<T> list, Class<T> security, MarketType marketType) {
        ...
        try
        {
            ...
            log.debug("appendSecurities[2]: Writing to Xml file");
    ...
    private <T extends Security> Optional<T> deleteSecurityByTicker(String ticker, Class<T> securityClass)  {
        ...
        try {
            ...
            log.debug("deleteSecurityByTicker: GetSecurity from xml file[]");
    ...
    private <T extends Security> Optional<T> getSecurityByTicker(String ticker, Class<T> securityClass)  {
        ...
        try {
            log.debug("getSecurityByTicker[2]: Get {} from XML[]", securityClass.getSimpleName());
            List<T> securityList = new ArrayList<>(read(securityClass));
    ...
    public Result<SecurityHistory> appendSecurityHistory(List<SecurityHistory> securityHistories, String ticker){
        ...
        log.info("Starting DataProviderXml appendSecuritiesHistory[0]");
        try {
    ...
    public Result<SecurityHistory> getSecurityHistories(String ticker) {
        log.info("Starting DataProviderXml getSecurityHistories[0]");
        try {
            ...
            log.error("Function DataProviderXml getSecurityHistory had crashed[1]: {}", e.getMessage());
            return new Result<>(FAIL, e.getMessage(), new ArrayList<>());
        }
    }
    ...
    public SecurityHistory getSecurityHistoryByDate(String ticker, String date){
        log.info("Starting DataProviderXml getSecurityHistoryByDate[0]");
        try {
            ...
            log.error("Function DataProviderXml getSecurityHistoryByDate had failed[3]: {}", e.getMessage());
        }
    ...
    public Result<SecurityHistory> deleteAllSecurityHistories(String ticker){
        log.info("Starting DataProviderXml deleteAllSecurityHistories[0]");
        try {
            ...
            log.error("Function DataProviderXml deleteAllSecurityHistories had failed[3]: {}", e.getMessage());
            return new Result<>(FAIL, e.getMessage(), new ArrayList<>());
        }
    ...
    public boolean appendOrUpdateSecurityHistory(SecurityHistory securityHistory, String ticker){
        log.info("Starting DataProviderXml appendOrUpdateSecurityHistory[0]");
        try {
            ...
            log.error("Function DataProviderXml appendOrUpdateSecurityHistory had failed[5]: {}", e.getMessage());
        }
        return false;
    }
    ...
    public Result<User> getUsers(){
        ...
        try {
            log.debug("getUsers[1]: Getting users from xml");
    ...
    public Result<User> updateUsers(List<User> users){
        ...
        try {
            ...
            MongoHistory.save(UPDATE, XML, usersToAppend);
    ...
    public Optional<User> updateUser(String id, String name){
        ...
        try {
            ...
            log.error("Function DataProviderXml updateUser had failed[4]: {}", e.getMessage());
        }
        return Optional.empty();
    }
    ...
    public Optional<User> deleteUserById(String id){
        ...
        try {
            ...
            if (user.isPresent()) {
                ...
                MongoHistory.save(DELETE, XML, user);
                return user;
            }
        }catch (Exception e){
    ...
    public Result<User> deleteAllUsers(){
        ...
        try {
            ...
            deleteAllActions();
            MongoHistory.save(DELETE, XML, users);
    ...
    public Optional<String> appendAction(ActionType actionType, String userID, String ticker){
        log.info("Starting DataProviderXml appendAction[0]");
        try {
            ...
            log.error("Function DataProviderXml appendAction had failed[5]: {}", e.getMessage());
        }
        return Optional.empty();
    }
    ...
    public Result<Action> deleteActionHistory(String userID){
        log.info("Starting DataProviderXml deleteAllUserAction[0]");
        try {
            Validator.isValid(userID);
            ...
            MongoHistory.save(DELETE, XML, actions);
    ...
    public String showHistory(String userId){
        log.info("Starting DataProviderXml showHistory[0]");
        try {
            Validator.isValid(userId);
            ...
            log.error("Function DataProviderXml showHistory had failed[3]: {}" , e.getMessage());
        }
        return "";
    }
